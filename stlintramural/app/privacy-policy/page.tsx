...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "How STL Intramural collects, uses, and protects your personal information.",
  path: "/privacy-policy",
});

export default function PrivacyPolicyPage() {
  return (
    <LegalPageShell title="Privacy Policy" lastUpdated="July 13, 2026">
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          this Privacy Policy) refers to STL Intramural.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to STL Intramural, accessible from{" "}
          <a
            href="https://stlintramural.vercel.app"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://stlintramural.vercel.app
          </a>
          .
        </li>
        <li>
