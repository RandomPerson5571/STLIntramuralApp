...
const TITLE_WORDS = ["Rewards", "Shop"];
...
export default function ShopPageHeader() {
  return (
    <div className="relative overflow-hidden border-b border-surface-variant/60 bg-gradient-to-br from-surface-bright via-surface to-surface-container-low/30 px-margin py-md md:px-lg md:py-lg">
      <div
        className="pointer-events-none absolute -right-16 -top-16 h-64 w-64 rounded-full bg-secondary/[0.06] blur-3xl"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute bottom-0 left-1/4 h-48 w-48 rounded-full bg-primary/[0.05] blur-3xl"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute right-1/3 top-1/2 h-24 w-24 rounded-full border border-secondary/10 bg-secondary/[0.03] backdrop-blur-sm"
        aria-hidden
      />
